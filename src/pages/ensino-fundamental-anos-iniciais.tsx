...
export default function EnsinoFundamentalAnosIniciais() {
  return (
    <>
      <Header />
      <HeroMedium
        image="initial"
        subtitle="Ensino fundamental anos iniciais"
        headline="Constrói as bases que permitirão ao aluno crescer e desenvolver seu processo de aprendizagem."
        description="
